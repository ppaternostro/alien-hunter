...
class SimpleGameFrame extends JFrame implements ActionListener
{
  ...
  public void actionPerformed(ActionEvent evt)
  {
    ...
    if (obj == gameStart)
    {
      ...
      gameTimer.schedule(new GameTask(),new Date(gameDuration = System.currentTimeMillis() + (gameTimeLimit = gameTimeLimit())));
  ...
  private class GameTask extends TimerTask
  {
    public void run()
    {
      ...
      SimpleGameFrame.this.gameStop.doClick();

      JOptionPane.showMessageDialog(
        SimpleGameFrame.this,
  ...
  private class StatusTask extends TimerTask
  {
    public void run()
    {
      ...
      if (SimpleGameFrame.this.canvas.getAlienCount() == 0 && gameTimeLimit > 0)
      {
        SimpleGameFrame.this.gameStop.doClick();
